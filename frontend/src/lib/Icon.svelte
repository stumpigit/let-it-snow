...
>
  ...
  {/if}
  {#if name === 'gpx'}
    <path d="M12 2c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9z" stroke-dasharray="3 3" />
    <circle cx="12" cy="12" r="3" />
  {/if}
  {#if name === 'layers'}
  ...
  {#if name === 'snowflake'}
    ...
    <polyline points="8 2 10 4 8 6" />
    <polyline points="16 2 14 4 16 6" />
    <polyline points="8 22 10 20 8 18" />
    <polyline points="16 22 14 20 16 18" />
    <polyline points="2 8 4 10 6 8" />
    <polyline points="2 16 4 14 6 16" />
    <polyline points="22 8 20 10 18 8" />
    <polyline points="22 16 20 14 18 16" />
  {/if}
  {#if name === 'shield'}
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
  {/if}
  {#if name === 'mountain'}
    <path d="M8 3l4 8 2-4 4 7H4z" />
    <path d="M3 20h18" />
  {/if}
</svg>
